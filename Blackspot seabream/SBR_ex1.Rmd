...
Tab1_Sfix <- sumspict.parest(fit1); Tab1_Sfix
Tab2_Sfix <- sumspict.srefpoints(fit1);Tab2_Sfix
Tab3_Sfix <- sumspict.states(fit1);Tab3_Sfix
Tab4_Sfix <- sumspict.predictions(fit1);Tab4_Sfix
```
